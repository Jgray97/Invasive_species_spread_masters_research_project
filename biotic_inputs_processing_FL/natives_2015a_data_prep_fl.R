...
# ENCOUNTER RATE IN 2015 IN FLORIDA PART A
# Author = John Gray
...
ebd_filters <- ebd %>%
  auk_state("US-FL") %>%
  auk_date(date = c("2015-01-01", "2015-06-30")) %>%
...
f_ebd <- file.path(data_dir, "ebd_all_species_FL_2015a.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_FL_2015a.txt")
...
write_csv(ebird_FL_all_species, "data/ebd_FL_all_species_2015a_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_FL_all_species_2015a_cell_stats.csv", na = "")
