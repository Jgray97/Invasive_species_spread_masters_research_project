...
# ENCOUNTER RATE BETWEEN 2005 and 2008 IN FLORIDA
# Author = John Gray
...
ebd_filters <- ebd %>%
  auk_state("US-FL") %>%
  auk_date(date = c("2005-01-01", "2008-12-31")) %>%
...
f_ebd <- file.path(data_dir, "ebd_all_species_FL_2005-2008.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_FL_2005-2008.txt")
...
write_csv(ebird_FL_all_species, "data/ebd_FL_all_species_2005-2008_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_FL_all_species_2005-2008_cell_stats.csv", na = "")
