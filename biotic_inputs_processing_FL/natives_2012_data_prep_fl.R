...
# ENCOUNTER RATE IN 2012 IN FLORIDA
# Author = John Gray
...
f_ebd <- file.path(data_dir, "ebd_all_species_FL_2012.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_FL_2012.txt")
...
write_csv(ebird_FL_all_species, "data/ebd_FL_all_species_2012_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_FL_all_species_2012_cell_stats.csv", na = "")
