...
# ENCOUNTER RATE IN 2015 IN FLORIDA PART B
# Author = John Gray
...
ebd_filters <- ebd %>%
  auk_state("US-FL") %>%
  auk_date(date = c("2015-07-01", "2015-12-31")) %>%
...
f_ebd <- file.path(data_dir, "ebd_all_species_FL_2015b.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_FL_2015b.txt")
...
write_csv(ebird_FL_all_species, "data/ebd_FL_all_species_2015b_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_FL_all_species_2015b_cell_stats.csv", na = "")
