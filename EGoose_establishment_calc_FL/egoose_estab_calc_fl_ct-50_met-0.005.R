...
fl_2000 <- ggplot() +
  ...
  geom_sf(data = wrapped_grid_fl2000, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2000, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
                        name = "Establishment Score") +
  scale_fill_gradient(low=NA, high = alpha("grey",0.4), guide = "none") +
...
fl_2001 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2001, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2001, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2002 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2002, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2003 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2003, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2003, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2004 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2004, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2005 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2005, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2005, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2006 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2006, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2007 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2007, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2007, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2008 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2008, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2009 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2009, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2009, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2010 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2010, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2011 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2011, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2011, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2012 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2012, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2013 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2013, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2013, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2014 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2014, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2015 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2015, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2015, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2016 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2016, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) + 
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2017 <- ggplot() +
  geom_polygon(data=countries, aes(x=long, y=lat, group=group), fill=NA, color="black") +
  geom_sf(data = wrapped_grid_fl2017, aes(fill = enough_checklists), color=alpha("white", 0.4)) +
  geom_point(data = wrapped_grid_fl2017, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2018 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2018, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
...
fl_2019 <- ggplot() +
  ...
  geom_point(data = wrapped_grid_fl2019, aes( x = lon_deg, y = lat_deg, 
                                            size = establishment_score)) +
  scale_size_continuous(limits = c(0,0.3), 
                        breaks = c(0.1,0.2,0.3),
                        range = c(-0.5,5),
