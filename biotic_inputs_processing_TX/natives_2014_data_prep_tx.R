...
# ENCOUNTER RATE IN 2014 IN TEXAS
# Author = John Gray
...
f_ebd <- file.path(data_dir, "ebd_all_species_TX_2014.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_TX_2014.txt")
...
write_csv(ebird_TX_all_species, "data/ebd_TX_all_species_2014_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_TX_all_species_2014_cell_stats.csv", na = "")
