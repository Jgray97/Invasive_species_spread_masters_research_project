...
ebd_filters <- ebd %>%
  auk_state("US-TX") %>%
  auk_date(date = c("2006-01-01", "2008-12-31")) %>%
...
f_ebd <- file.path(data_dir, "ebd_all_species_TX_2006-2008.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_TX_2006-2008.txt")
...
write_csv(ebird_TX_all_species, "data/ebd_TX_all_species_2006-2008_zf.csv", na = "")
