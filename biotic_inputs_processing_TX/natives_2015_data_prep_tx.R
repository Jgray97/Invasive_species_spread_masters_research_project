...
# ENCOUNTER RATE IN 2015 IN TEXAS
# Author = John Gray
...
f_ebd <- file.path(data_dir, "ebd_all_species_TX_2015.txt")
f_sampling <- file.path(data_dir, "ebd_checklists_all_species_TX_2015.txt")
...
write_csv(ebird_TX_all_species, "data/ebd_TX_all_species_2015_zf.csv", na = "")

write_csv(cell_stats, "data/ebd_TX_all_species_2015_cell_stats.csv", na = "")
