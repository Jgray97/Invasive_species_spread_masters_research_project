...
# establishment_tracker <- read.csv("data/FL_egoose_establishment_ct-50_met-0.csv")
...
ggsave(filename = "plots_fl_egoose_final/ct-50_met-0/33453_checklists_per_year.png", width = 10, height = 7)
...
ggplot(data = miami_example_2, aes(x=year)) +
  ...
  annotate(geom = "text", x = 2011, y = 0.002, label = "Minimum encounter rate threshold = 0") +
...
ggsave(filename = "plots_fl_egoose_final/ct-50_met-0/33453_encounter_rate_establishment_score_per_year.png", width = 10, height = 7)
