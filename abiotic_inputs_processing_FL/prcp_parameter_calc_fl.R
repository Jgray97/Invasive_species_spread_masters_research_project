# CALCULATING PRECIPITATION RF PARAMETER VALUES FOR GRID CELLS ACROSS FLORIDA
# Author = John Gray
...
# Load in Florida establishment tracker to provide grid cell IDs for Florida 
# cells
...
# this for loop generates a dataframe of precipitation levels across florida 
...
for (i in 2000:2022) {
  ...
  # filter the prcp dataframe to just points contained within florida cells
